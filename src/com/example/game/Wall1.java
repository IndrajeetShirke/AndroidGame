...
public class Wall1 {
	...
	public Wall1(Camera camera) {
		...
		sprite = new Sprite(this.camera.getWidth()/2,this.camera.getHeight(),MainActivity.getSharedInstance().wallTextureRegion,MainActivity.getSharedInstance().getVertexBufferObjectManager());
